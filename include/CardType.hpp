...
/**
  * @brief Encoding tool for typeline into TypeEncoding
  * @param type_line string containing the type of the card (passed by ref)
  * @return TypeEncoding representing the Supertype and Type from given typeline
  */
